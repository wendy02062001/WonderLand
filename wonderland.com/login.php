...
<body>
	<?php
		...
		if (count($errors) == 0) {
			...
			header('location: http://localhost/khanhlinh.com');
			}else {
				array_push($errors, "Wrong username/password combination");
				echo "<script>if(confirm('Wrong username/password combination')){document.location.href='http://localhost/khanhlinh.com/login.php'};</script>";
			}
		}
		}
	?>
		...
		<div class="container-login">
			<div class="wrap-login">
				<div class="login-pic js-tilt" data-tilt>
					<img src="image/login-dog.png" alt="IMG">
				</div>
				...
				<form class="login-form validate-form" method="post" action = "login.php">
					...
					<div class="wrap-input validate-input" data-validate = "Valid email is required">
						<input id="username" class="input" type="text" name="username" placeholder="Username" onkeyup="validEmail()" require>
					...
					<div class="wrap-input validate-input" data-validate = "Password is required">
						<input id="psw" class="input" type="password" name="pass"  placeholder="Password" onkeyup="validation()" require>
						<span class="focus-input"></span>
						<span class="symbol-input">
